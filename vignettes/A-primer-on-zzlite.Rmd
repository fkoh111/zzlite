...
In the example above, `avatar.emf` is the file that I've requested Zamzar to convert. The extension is the requested extension that I want my file to have _after_ conversion. The prod bool decides whether or not we should use a development endpoint or a production endpoint. For more information on differences between endpoints, see: [Test and production environments](https://developers.zamzar.com/docs) in the official Zamzar documentation.
