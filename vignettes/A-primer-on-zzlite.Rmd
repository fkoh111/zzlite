...
Assuming that we've posted the `avatar.emf` to Zamzar and have received a 201 reply from the API, a subsequent invocation of `zz_get_info()` will return a table like this:
