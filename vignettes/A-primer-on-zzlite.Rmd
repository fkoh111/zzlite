...
In the example above, `avatar.emf` is the file that we've requested Zamzar to convert. The paramter `extension` is the extension/format we want the file to have _after_ conversion.  
