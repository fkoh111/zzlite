...
test_that("we're only reading in files with capital .R extension (strict param defaults to true)", {
...
test_that("we're reading in files with both capital and lowercase .R/.r extensions by
          switching param strict to FALSE", {
